<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="当前章节ID" prop="chapterId">
        <el-input
          v-model="queryParams.chapterId"
          placeholder="请输入当前章节ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="recordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="阅读记录ID" align="center" prop="recordId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="当前章节ID" prop="chapterId">
          <el-input v-model="form.chapterId" placeholder="请输入当前章节ID" />
        </el-form-item>
        <el-form-item label="最后更新时间" prop="lastUpdated">
          <el-date-picker clearable
...
<script>
import { listRecord, getRecord, delRecord, addRecord, updateRecord } from "@/api/guji/record";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        chapterId: [
          { required: true, message: "当前章节ID不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除阅读记录编号为"' + recordIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('guji/record/export', {
        ...this.queryParams
